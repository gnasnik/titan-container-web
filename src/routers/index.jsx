...
const Providers = lazy(() => import('@/views/dashboard/providers'));
const Deployments = lazy(() => import('@/views/dashboard/deployments'));
const CreateDeployment = lazy(() => import('@/views/dashboard/deployments/create'));
const DeploymentDetail = lazy(() => import('@/views/dashboard/deployments/detail'))
  ...
  },
  {
    ...
    children: [
      ...
      },
      {
        ...
        element: load(<Providers />),
        meta: {
          name: 'menu.dashboard.providers',
          title: 'Providers'
        }
      },
      {
        path: 'deployments',
        key: '/dashboard/deployments',
        element: load(<Deployments />),
        meta: {
          name: 'menu.dashboard.deployments',
          title: 'Deployments'
        }
      },
      {
        path: 'deployments/create',
        key: '/dashboard/deployments/create',
        element: load(<CreateDeployment />),
        meta: {
          name: 'menu.dashboard.deployment.create',
          title: 'Deployment'
        }
      },
      {
        path: 'deployments/detail',
        key: '/dashboard/deployments/detail',
        element: load(<DeploymentDetail />),
        meta: {
          name: 'menu.dashboard.deployment.detail',
          title: 'Deployment'
        }
      },
    ]
